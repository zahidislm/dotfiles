# Generated by Powerlevel10k configuration wizard on 2023-12-18 at 13:28 EST.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=14
  ...
  typeset -g POWERLEVEL9K_DISK_USAGE_WARNING_FOREGROUND=1
  ...
  typeset -g POWERLEVEL9K_GOOGLE_APP_CRED_CLASSES=(
      ...
      # '*:*test*:*'  TEST    # to match your needs. Customize them as needed.
      '*'             DEFAULT)
  typeset -g POWERLEVEL9K_GOOGLE_APP_CRED_DEFAULT_FOREGROUND=15
  typeset -g POWERLEVEL9K_GOOGLE_APP_CRED_DEFAULT_BACKGROUND=17
  ...
  ################################[ battery: internal battery ]#################################
  # Force the general background to be completely transparent
  typeset -g POWERLEVEL9K_BATTERY_BACKGROUND=

  # Force all state-specific backgrounds to be transparent (overrides hidden defaults)
  typeset -g POWERLEVEL9K_BATTERY_{CHARGING,CHARGED,DISCONNECTED,LOW}_BACKGROUND=

  # Remove the powerline separator triangles so you don't get floating colored blocks
  typeset -g POWERLEVEL9K_BATTERY_RIGHT_SEGMENT_SEPARATOR=''
  typeset -g POWERLEVEL9K_BATTERY_LEFT_SEGMENT_SEPARATOR=''

  # Strip the start/end frame symbols when battery is on the right prompt
  typeset -g POWERLEVEL9K_BATTERY_RIGHT_PROMPT_FIRST_SEGMENT_START_SYMBOL=''
  typeset -g POWERLEVEL9K_BATTERY_RIGHT_PROMPT_LAST_SEGMENT_END_SYMBOL=''
